    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const res = await submitCohousingFormAction(formData);
            if (res.success) {
                ...
                const url = `https://wa.me/5511925729548?text=${encodeURIComponent(msg)}`;
                setWhatsappUrl(url);
        ...
        <div className={isModal ? 'bg-white rounded-3xl p-6 md:p-10 shadow-2xl' : 'container mx-auto px-6 lg:px-12 max-w-4xl'}>
            ...
            {!isSubmitted ? (
                ...
                <div className="text-center py-16 animate-in fade-in zoom-in duration-500">
                    ...
                    <h3 className="text-3xl font-bold text-primary-900 mb-4">Etapa Final Obrigatória</h3>
                    <p className="text-gray-600 mb-8 max-w-md mx-auto">Para concluir seu cadastro e enviar sua ficha para a nossa curadoria, é necessário clicar no botão abaixo e nos mandar a mensagem gerada no WhatsApp.</p>
                    
                    <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-[#25D366] text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-[#1EBE5A] transition-colors mb-6 shadow-lg hover:shadow-xl hover:-translate-y-1" onClick={onClose}>
