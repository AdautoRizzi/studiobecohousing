    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const res = await submitCohousingFormAction(formData);
            if (res.success) {
                ...
                const url = `https://wa.me/5511934898990?text=${encodeURIComponent(msg)}`;
                setWhatsappUrl(url);
        ...
        <div className={isModal ? 'bg-white rounded-3xl p-6 md:p-10 shadow-2xl' : 'container mx-auto px-6 lg:px-12 max-w-4xl'}>
            ...
            {!isSubmitted ? (
                ...
                <div className="text-center py-16 animate-in fade-in zoom-in duration-500">
                    ...
                    <h3 className="text-3xl font-bold text-primary-900 mb-4">Falta Só Mais Um Passo!</h3>
                    <p className="text-gray-600 mb-8 max-w-md mx-auto">Recebemos seus dados, mas para agilizar seu atendimento, clique no botão abaixo para enviar sua ficha diretamente para o nosso WhatsApp.</p>
                    
                    <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-[#25D366] text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-[#1EBE5A] transition-colors mb-6 shadow-lg hover:shadow-xl hover:-translate-y-1">
