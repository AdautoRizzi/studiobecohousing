...
export default function DashboardLayout({
    ...
    const navigation = [
        ...
        { name: 'Suporte (WhatsApp)', href: 'https://wa.me/5511925729548', icon: <svg className="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" /></svg>, isExternal: true },
    ];
