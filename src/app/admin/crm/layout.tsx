        ...
        <div className="min-h-screen bg-[#020617] flex flex-col md:flex-row">
            ...
            <aside className="w-full md:w-64 bg-[#0f172a] border-r border-slate-800 flex-shrink-0 flex flex-col">
                ...
                <nav className="flex-1 p-4 flex flex-col gap-2">
                    ...
                    <Link href="/admin/crm/blog" className="flex items-center gap-3 px-3 py-2 text-purple-400 bg-slate-800/50 hover:bg-slate-800 rounded-lg font-medium transition-colors border border-purple-500/20 mb-2">
                    ...
                    <Link href="/admin/crm/membros" className="flex items-center gap-3 px-3 py-2 text-yellow-400 bg-slate-800/50 hover:bg-slate-800 rounded-lg font-medium transition-colors border border-yellow-500/20 mb-2 mt-4">
