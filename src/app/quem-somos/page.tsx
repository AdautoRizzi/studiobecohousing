                ...
                <div className="container mx-auto px-6 py-20 lg:py-32">
                    ...
                    <div className="text-center mb-24 max-w-4xl mx-auto">
                        ...
                        <h1 className="text-4xl md:text-6xl font-bold text-gray-900 tracking-tight leading-tight mb-8">
                            Nós somos a <span className="text-secondary-600">Studio Be</span>
                        </h1>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
                        <div className="order-2 lg:order-1">
                            ...
                            <p className="text-gray-700 text-lg leading-relaxed">
                                Somos um estúdio multidisciplinar que une arquitetura inovadora, gestão ágil e facilitação de grupos para desenhar "Vilas do Século 21". Nossos projetos não são condomínios, são ecossistemas vivos onde vizinhos operam como uma rede de apoio mútuo.
                            </p>
                    ...
                    <div className="bg-primary-900 text-white rounded-[3rem] p-12 lg:p-20 shadow-xl overflow-hidden relative">
                        ...
                        <div className="relative z-10 text-center max-w-3xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 text-left">
                                ...
                                <div className="lg:col-span-2 bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                                    <div className="text-4xl mb-4">🌟</div>
                                    <h3 className="text-xl font-bold mb-3 text-white">Solução "One-Stop-Shop" para Longevidade</h3>
                                    <p className="text-sm text-primary-100 leading-relaxed">Integramos arquitetura, psicologia e gerontologia em uma única jornada. Cuidamos de tudo: do despertar do desejo à viabilização jurídica e gestão da convivência.</p>
                                </div>
                                <div className="lg:col-span-2 bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                                    <div className="text-4xl mb-4">💡</div>
